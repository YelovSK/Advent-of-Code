...
# Get directories that are bigger than the space to free and sort them by size
directories = [d for d in tree.get_directories(tree.root) if d.get_size() - tree.space_to_free() >= 0]
directories = sorted(directories, key=lambda x: x.get_size())

print("Part 2:", directories[0].get_size())
